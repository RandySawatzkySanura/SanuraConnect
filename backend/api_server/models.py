...
class InventoryWebSupplement(models.Model):
    ...
    keyFeature1 = models.CharField(max_length=1000, blank=True, null=True)
    keyFeature2 = models.CharField(max_length=1000, blank=True, null=True)
    keyFeature3 = models.CharField(max_length=1000, blank=True, null=True)
    keyFeature4 = models.CharField(max_length=1000, blank=True, null=True)
    ...
    burried_freight = models.DecimalField(max_digits=5, decimal_places=2, blank=True, null=True)
    ...
    dim_weight_lb_ups = models.DecimalField (max_digits=5,decimal_places=2, blank=True, null=True)
    dim_weight_lb_canadapost = models.DecimalField (max_digits=5,decimal_places=2, blank=True, null=True)
